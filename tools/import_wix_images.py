...
def main() -> None:
    ...
    # The catalogue is a collection: one file per work.
    for works_f in sorted(ROOT.glob("content/artworks/*.json")):
        w = json.loads(works_f.read_text(encoding="utf-8"))
        ...
        works_f.write_text(json.dumps(w, indent=2, ensure_ascii=False) + '\n', encoding="utf-8")
